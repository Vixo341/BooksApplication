...
using BooksApplication.Utility;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Stripe.Checkout;
using System.Security.Claims;

namespace BooksApplication.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefault(u => u.OrderHeaderId == orderId);
        ...
        {
            var cart = _unitOfWork.ShoppingCart.GetFirstOrDefault(u => u.ShoppingCartId == cartId);
